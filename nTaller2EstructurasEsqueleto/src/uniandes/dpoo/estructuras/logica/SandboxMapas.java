...
public class SandboxMapas
{
    ...
    {
        List<String> LlavesMapCadenas = new ArrayList<>();
        for (String llave : mapaCadenas.keySet()) 
        {
            LlavesMapCadenas.add(llave.toUpperCase());
        }
        return LlavesMapCadenas;
    }
    ...
    {
    	int count =0;
    	List<String> values = new ArrayList<>(this.mapaCadenas.values());
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	String invert = new String(letras);
    	
    	this.mapaCadenas.put(invert, cadena);
